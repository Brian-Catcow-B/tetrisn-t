    ...
    pub fn spawn(&mut self, spawn_column: u8) {
        match self.shape {
            ...
            Shapes::O => {
                self.positions = [
                    (spawn_column - 1, 0), // [#][#][#][#]
                    (spawn_column - 1, 0), // [#][0][1][#]
                    (spawn_column + 0, 1), // [#][2][3][#]
                    (spawn_column + 0, 1), // [#][#][#][#]
                ]
            },
            Shapes::T => {
                self.positions = [
                    (spawn_column - 1, 0), // [#][#][#][#] | [#][#][0][#] | [#][#][3][#] | [#][#][2][#]
                    (spawn_column + 0, 0), // [#][0][1][2] | [#][3][1][#] | [#][2][1][0] | [#][#][1][3]
                    (spawn_column + 1, 0), // [#][#][3][#] | [#][#][2][#] | [#][#][#][#] | [#][#][0][#]
                    (spawn_column + 0, 1), // [#][#][#][#] | [#][#][#][#] | [#][#][#][#] | [#][#][#][#]
                ]
            },
            Shapes::J => {
                self.positions = [
                    (spawn_column - 1, 0), // [#][#][#][#] | [#][#][0][#] | [#][3][#][#] | [#][#][2][3]
                    (spawn_column + 0, 0), // [#][0][1][2] | [#][#][1][#] | [#][2][1][0] | [#][#][1][#]
                    (spawn_column + 1, 0), // [#][#][#][3] | [#][3][2][#] | [#][#][#][#] | [#][#][0][#]
                    (spawn_column + 1, 1), // [#][#][#][#] | [#][#][#][#] | [#][#][#][#] | [#][#][#][#]
                ]
            },
            Shapes::L => {
                self.positions = [
                    (spawn_column - 1, 0), // [#][#][#][#] | [#][3][0][#] | [#][#][#][3] | [#][#][2][#]
                    (spawn_column + 0, 0), // [#][0][1][2] | [#][#][1][#] | [#][2][1][0] | [#][#][1][#]
                    (spawn_column + 1, 0), // [#][3][#][#] | [#][#][2][#] | [#][#][#][#] | [#][#][0][3]
                    (spawn_column - 1, 1), // [#][#][#][#] | [#][#][#][#] | [#][#][#][#] | [#][#][#][#]
                ]
            },
            Shapes::S => {
                self.positions = [
                    (spawn_column + 0, 0), // [#][#][#][#] | [#][#][1][#]
                    (spawn_column + 1, 0), // [#][#][0][1] | [#][#][0][3]
                    (spawn_column - 1, 1), // [#][2][3][#] | [#][#][#][2]
                    (spawn_column + 0, 1), // [#][#][#][#] | [#][#][#][#]
                ]
            },
            Shapes::Z => {
                self.positions = [
                    (spawn_column - 1, 0), // [#][#][#][#] | [#][#][#][3]
                    (spawn_column + 0, 0), // [#][0][1][#] | [#][#][1][2]
                    (spawn_column + 0, 1), // [#][#][2][3] | [#][#][0][#]
                    (spawn_column + 1, 1), // [#][#][#][#] | [#][#][#][#]
                ]
            },
        }
